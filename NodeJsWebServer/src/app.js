...
const { startCameraTimelapseCaptureSupervisor } = require("./services/cameraTimelapseCaptureService");
...
const consoleRoutes = require("./routes/console/console.js");
...
app.use("/console", authGuard, consoleRoutes);
